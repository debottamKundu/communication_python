...
def extract_records(data_dict, source_type, animal_idx):
    """Extracts records as a list of dicts, filtering out unwanted frames immediately."""
    records = []
    for region_1, nested_dict in data_dict.items():
...
if __name__ == "__main__":
    ...
    all_records = []
    for idx, eid in tqdm(enumerate(sessions), total=len(sessions)):
        ...
        try:
            ...
            print(f"Error with {eid}, probably not generated yet. Details: {e}")
            continue
